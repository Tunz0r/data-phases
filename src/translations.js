...
const PHASES_EN = [
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Owns the engagement layer (channels). Consumes shared data products and personalisation decisions made by the decision layer \u2014 does not own decisioning itself. Ensures all channels deliver consistent, tailored experiences.',
        capabilities: [
          { icon: 'yes', text: 'Shared datasets and a unified customer view available via standard interfaces' },
          { icon: 'yes', text: 'Consumes personalisation decisions from the decision layer as ready-to-use services' },
          { icon: 'yes', text: 'Owns the engagement layer: Play, tv2.dk, Sport, Vejr deliver consistent experiences' },
          { icon: 'yes', text: 'Common data model ensures the same definitions across all channels' },
          { icon: 'yes', text: 'Does not build decisioning logic \u2014 integrates decisions made by Data & AI Professionals' },
        ],
        tools: ['Databricks APIs', 'Adobe Experience Platform', 'Event Streaming'],
        spoke: 'Spoke \u201clille/mellem\u201d \u2014 owns channels, consumes decisions',
        maturity: { access: 3, governance: 2.5, ai: 2.5, value: 3 },
        tempo: 'both',
      },
      {
        desc: 'Owns the decision layer: personalisation logic, ML models, recommendation algorithms. Works both in Hub (platform & shared models) and in product teams (domain-specific decisioning). Ensures data, decisions, and channels work together.',
        capabilities: [
          { icon: 'yes', text: 'Full Databricks platform: data storage, AI/ML, governance tooling' },
          { icon: 'yes', text: 'Owns decisioning & personalisation: builds the models that drive tailored experiences' },
          { icon: 'yes', text: 'Data governance enforced via tooling \u2014 clear ownership, quality tracking' },
          { icon: 'yes', text: 'Works in Hub (shared platform) and in product teams (domain-specific models)' },
        ...
        spoke: 'Spoke \u201cstor\u201d (large) + Hub \u2014 owns the platform & decision layer',
...
const PHASES_DA = [
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Ejer engagement-laget (kanaler). Forbruger f\u00e6lles dataprodukter og personaliseringsbeslutninger fra beslutningslaget \u2014 ejer ikke decisioning selv. Sikrer at alle kanaler leverer konsistente, skr\u00e6ddersyede oplevelser.',
        capabilities: [
          { icon: 'yes', text: 'F\u00e6lles datas\u00e6t og samlet kundebillede tilg\u00e6ngeligt via standard-interfaces' },
          { icon: 'yes', text: 'Forbruger personaliseringsbeslutninger fra beslutningslaget som f\u00e6rdige services' },
          { icon: 'yes', text: 'Ejer engagement-laget: Play, tv2.dk, Sport, Vejr leverer konsistente oplevelser' },
          { icon: 'yes', text: 'F\u00e6lles datamodel sikrer samme definitioner p\u00e5 tv\u00e6rs af alle kanaler' },
          { icon: 'yes', text: 'Bygger ikke decisioning-logik \u2014 integrerer beslutninger fra Data & AI Specialister' },
        ],
        tools: ['Databricks APIs', 'Adobe Experience Platform', 'Event Streaming'],
        spoke: 'Spoke \u201clille/mellem\u201d \u2014 ejer kanaler, forbruger beslutninger',
        maturity: { access: 3, governance: 2.5, ai: 2.5, value: 3 },
        tempo: 'both',
      },
      {
        desc: 'Ejer beslutningslaget: personaliseringslogik, ML-modeller, anbefalingsalgoritmer. Arbejder b\u00e5de i Hub (platform & f\u00e6lles modeller) og i produktteams (dom\u00e6nespecifik decisioning). Sikrer at data, beslutninger og kanaler fungerer sammen.',
        capabilities: [
          { icon: 'yes', text: 'Fuld Databricks-platform: datalagring, AI/ML, governance-v\u00e6rkt\u00f8jer' },
          { icon: 'yes', text: 'Ejer decisioning & personalisering: bygger modellerne der driver skr\u00e6ddersyede oplevelser' },
          { icon: 'yes', text: 'Data governance h\u00e5ndh\u00e6vet via v\u00e6rkt\u00f8jer \u2014 klart ejerskab, kvalitetssporing' },
          { icon: 'yes', text: 'Arbejder i Hub (f\u00e6lles platform) og i produktteams (dom\u00e6nespecifikke modeller)' },
          { icon: 'yes', text: 'Hub services: r\u00e5dgivning, engineering-support, tr\u00e6ning, platformsdrift' },
        ],
        tools: ['Databricks Unity Catalog', 'ML Platform', 'Adobe CDP', 'Governance Tooling'],
        spoke: 'Spoke \u201cstor\u201d + Hub \u2014 ejer platformen & beslutningslaget',
        maturity: { access: 3.5, governance: 3, ai: 3.5, value: 2.5 },
        tempo: 'both',
      },
      {
