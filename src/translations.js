  ...
  sections: [
    ...
    { key: 'principles', css: 'vibe-comms-principles', iconBg: 'rgba(139, 92, 246, 0.15)', iconColor: '#8b5cf6', icon: '\u2605', title: 'Five principles for vibe coding at TV 2',
      principles: [
        ...
        { da: 'Kend din zone.', text: 'Check the matrix above. Green means go. Yellow means discuss with Architecture. Red means this needs full governance.' },
      ],
    },
    { key: 'alignment', css: 'vibe-comms-alignment', iconBg: 'rgba(59, 130, 246, 0.15)', iconColor: '#3b82f6', icon: '?', title: 'What we need alignment on',
      list: [
        ...
        ['Do we agree that ', { b: 'Architecture owns the tool approval and governance framework' }, ' for vibe coding, consistent with our technology strategy?'],
  ...
  sections: [
    ...
    { key: 'principles', css: 'vibe-comms-principles', iconBg: 'rgba(139, 92, 246, 0.15)', iconColor: '#8b5cf6', icon: '\u2605', title: 'Fem principper for vibe coding hos TV 2',
      principles: [
        ...
        { da: 'Kend din zone.', text: 'Tjek matrixen ovenfor. Gr\u00f8n betyder k\u00f8r. Gul betyder diskut\u00e9r med Arkitektur. R\u00f8d betyder dette kr\u00e6ver fuld governance.' },
      ],
    },
    { key: 'alignment', css: 'vibe-comms-alignment', iconBg: 'rgba(59, 130, 246, 0.15)', iconColor: '#3b82f6', icon: '?', title: 'Hvad vi har brug for alignment p\u00e5',
      list: [
        ...
        ['Er vi enige om at ', { b: 'Arkitektur ejer v\u00e6rkt\u00f8jsgodkendelse og governance-framework' }, ' for vibe coding, konsistent med vores teknologistrategi?'],
