...
const PERSONAS_EN = [
  ...
  { id: 'hub-eng', label: 'Hub Data & AI Engineer', sublabel: 'IT \u2014 platform, decision layer, shared models', color: '#10b981', icon: '\u{2699}\u{FE0F}' },
...
const PERSONAS_DA = [
  ...
  { id: 'hub-eng', label: 'Hub Data & AI Ingeni\u00f8r', sublabel: 'IT \u2014 platform, beslutningslag, f\u00e6lles modeller', color: '#10b981', icon: '\u{2699}\u{FE0F}' },
...
const PHASES_EN = [
  {
    ...
    personas: [
      ...
      {
        desc: 'No shared platform exists yet. Data engineering is fragmented across teams. No Hub, no shared decisioning, no EMP. Every team builds their own solutions independently.',
        capabilities: [
          { icon: 'partial', text: 'Separate cloud platforms per team \u2014 no consolidation' },
          { icon: 'no', text: 'No shared data platform or decision layer' },
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Building the shared platform in the Hub. Consolidating data engineering on Databricks. Starting to build EMP foundation and shared decisioning capabilities. Providing engineering support to all teams.',
        capabilities: [
          { icon: 'yes', text: 'Single Databricks platform for data engineering and AI/ML' },
          { icon: 'partial', text: 'EMP foundation being built \u2014 priority on vertical value delivery' },
          { icon: 'yes', text: 'Data governance framework established \u2014 clear ownership model' },
          { icon: 'partial', text: 'Shared decisioning capabilities starting to move out of channels' },
          { icon: 'yes', text: 'Hub team providing advisory and engineering support to spokes' },
        ],
        tools: ['Databricks', 'EMP (forming)', 'Deployment Automation', 'Adobe CDP'],
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Owns the decision layer technically: builds the EMP, EOL, ML models, and recommendation algorithms. Works both in Hub (platform & shared models) and in a Customer Experience team (cross-domain decisioning). Ensures data, decisions, and channels work together.',
        capabilities: [
          { icon: 'yes', text: 'Full Databricks platform: data storage, AI/ML, governance tooling' },
          { icon: 'yes', text: 'Builds & operates the EMP: content curation, journey decisioning, segmentation, A/B testing' },
          { icon: 'yes', text: 'Builds the EOL: content orchestration, cross-channel consistency, real-time triggers' },
        ...
        tools: ['Databricks Unity Catalog', 'EMP', 'EOL', 'ML Platform', 'Adobe CDP'],
        spoke: 'Spoke \u201cstor\u201d + Hub \u2014 owns decision layer (EMP/EOL) & data platform',
...
const PHASES_DA = [
  {
    ...
    personas: [
      ...
      {
        desc: 'Ingen f\u00e6lles platform eksisterer endnu. Data engineering er fragmenteret p\u00e5 tv\u00e6rs af teams. Ingen Hub, ingen f\u00e6lles decisioning, ingen EMP. Hvert team bygger egne l\u00f8sninger uafh\u00e6ngigt.',
        capabilities: [
          { icon: 'partial', text: 'Separate cloud-platforme per team \u2014 ingen konsolidering' },
          { icon: 'no', text: 'Ingen f\u00e6lles dataplatform eller beslutningslag' },
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Bygger den f\u00e6lles platform i Hub. Konsoliderer data engineering p\u00e5 Databricks. Begynder at bygge EMP-fundament og f\u00e6lles decisioning-kapabiliteter. Leverer engineering-support til alle teams.',
        capabilities: [
          { icon: 'yes', text: '\u00c9n samlet Databricks-platform til data engineering og AI/ML' },
          { icon: 'partial', text: 'EMP-fundament under opbygning \u2014 prioritet p\u00e5 vertikal v\u00e6rdilevering' },
          { icon: 'yes', text: 'Data governance-framework etableret \u2014 klar ejerskabsmodel' },
          { icon: 'partial', text: 'F\u00e6lles decisioning-kapabiliteter begynder at flytte ud af kanaler' },
          { icon: 'yes', text: 'Hub-teamet leverer r\u00e5dgivning og engineering-support til spokes' },
        ],
        tools: ['Databricks', 'EMP (under opbygning)', 'Deployment Automation', 'Adobe CDP'],
        maturity: { access: 2.5, governance: 2, ai: 2, value: 1.5 },
        tempo: 'both',
      },
      {
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Ejer beslutningslaget teknisk: bygger EMP, EOL, ML-modeller og anbefalingsalgoritmer. Arbejder b\u00e5de i Hub (platform & f\u00e6lles modeller) og i et Customer Experience-team (tv\u00e6rg\u00e5ende decisioning). Sikrer at data, beslutninger og kanaler fungerer sammen.',
        capabilities: [
          { icon: 'yes', text: 'Fuld Databricks-platform: datalagring, AI/ML, governance-v\u00e6rkt\u00f8jer' },
          { icon: 'yes', text: 'Bygger & driver EMP: content curation, journey decisioning, segmentering, A/B-test' },
          { icon: 'yes', text: 'Bygger EOL: indholdsorkestration, tv\u00e6rkanal-konsistens, realtidstriggers' },
        ...
        tools: ['Databricks Unity Catalog', 'EMP', 'EOL', 'ML Platform', 'Adobe CDP'],
        spoke: 'Spoke \u201cstor\u201d + Hub \u2014 ejer beslutningslaget (EMP/EOL) & dataplatform',
        maturity: { access: 3.5, governance: 3, ai: 3.5, value: 2.5 },
        tempo: 'both',
      },
      {
