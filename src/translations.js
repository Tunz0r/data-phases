...
const PHASES_EN = [
  ...
  },
  {
    ...
    personas: [
      ...
      },
      {
        ...
        tools: ['Databricks (AWS)', 'EMP (forming)', 'CI/CD', 'Observability (forming)'],
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Builds data products, AI solutions, and configures personalisation rules on the shared platform. Configures segments, eligibility rules, and audience targeting in the Experience Management Platform (EMP).',
        capabilities: [
      ...
      {
        desc: 'Spans two Hub domains. Data Foundation: owns the data platform, data products, EMP/EOL decision layer, ML models, and shared ontology. Tech Enabling: owns dev platforms, infrastructure, CI/CD, observability, security, and integration platform.',
        capabilities: [
          { icon: 'yes', text: 'Data Foundation: Databricks platform, data products, Unity Catalog, common data model' },
          { icon: 'yes', text: 'Data Foundation: builds & operates EMP/EOL \u2014 decisioning, curation, orchestration' },
        ...
        tools: ['Databricks Unity Catalog', 'EMP', 'EOL', 'ML Platform', 'CI/CD', 'Observability'],
      ...
      {
        desc: 'Builds and operates AI factories within product teams. Each team can have its own AI factory with domain-specific agents and local technology choices. Hub provides shared building blocks and patterns, but does not centralise all AI.',
        capabilities: [
          { icon: 'yes', text: 'Product teams own their AI factories \u2014 agents, models, and domain logic' },
          { icon: 'yes', text: 'Agent instructions can be dictated by local technology choices and domain needs' },
        ...
        spoke: 'Product teams \u2014 own their AI factories, use shared building blocks',
...
const PHASES_DA = [
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Begge Hub-dom\u00e6ner konsoliderer. Azure \u2192 AWS-migrering f\u00e6rdigg\u00f8res \u2014 Data Foundation k\u00f8rer nu Databricks p\u00e5 AWS og begynder at bruge Tech Enablings infrastruktur, CI/CD og observability. EMP-fundament under opbygning. Tech Enabling: etablerer f\u00e6lles dev-platformstandarder og evaluerer integrationsplatform.',
        capabilities: [
        ...
        tools: ['Databricks (AWS)', 'EMP (under opbygning)', 'CI/CD', 'Observability (under opbygning)'],
        maturity: { access: 2.5, governance: 2, ai: 2, value: 1.5 },
        tempo: 'both',
      },
      {
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Bygger dataprodukter, AI-l\u00f8sninger og konfigurerer personaliseringsregler p\u00e5 den f\u00e6lles platform. Konfigurerer segmenter, eligibility-regler og m\u00e5lgrupperetning i Experience Management Platformen (EMP).',
        capabilities: [
      ...
      {
        desc: 'D\u00e6kker to Hub-dom\u00e6ner. Data Foundation: ejer dataplatformen, dataprodukter, EMP/EOL-beslutningslaget, ML-modeller og f\u00e6lles ontologi. Tech Enabling: ejer udviklingsplatforme, infrastruktur, CI/CD, observability, sikkerhed og integrationsplatform.',
        capabilities: [
          { icon: 'yes', text: 'Data Foundation: Databricks-platform, dataprodukter, Unity Catalog, f\u00e6lles datamodel' },
          { icon: 'yes', text: 'Data Foundation: bygger & driver EMP/EOL \u2014 decisioning, curation, orkestration' },
      ...
      {
        desc: 'Bygger og driver AI-fabrikker inden for produktteams. Hvert team kan have sin egen AI-fabrik med dom\u00e6nespecifikke agenter og lokale teknologivalg. Hub leverer f\u00e6lles byggeklodser og m\u00f8nstre, men centraliserer ikke al AI.',
        capabilities: [
          { icon: 'yes', text: 'Produktteams ejer deres AI-fabrikker \u2014 agenter, modeller og dom\u00e6nelogik' },
          { icon: 'yes', text: 'Agent-instruktioner kan v\u00e6re dikteret af lokale teknologivalg og dom\u00e6nebehov' },
        ...
        tools: ['Databricks AI', 'Agent Framework', 'AI Model Management', 'AI Governance Tooling'],
        spoke: 'Produktteams \u2014 ejer deres AI-fabrikker, bruger f\u00e6lles byggeklodser',
        maturity: { access: 3.5, governance: 3, ai: 3.5, value: 3 },
        tempo: 'operational',
      },
    ],
