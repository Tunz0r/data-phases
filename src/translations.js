...
const PHASES_EN = [
  {
    ...
    personas: [
      ...
      {
        desc: 'No shared platform exists yet. Neither Data Foundation nor Tech Enabling have consolidated platforms. Data engineering is fragmented, no shared decisioning, no EMP. Every team builds independently.',
        capabilities: [
          { icon: 'partial', text: 'Separate cloud platforms per team \u2014 no consolidation' },
          { icon: 'no', text: 'No shared data platform (Data Foundation) or dev standards (Tech Enabling)' },
          { icon: 'no', text: 'No common framework for data quality or ownership' },
          { icon: 'no', text: 'No observability, no shared CI/CD, no integration platform' },
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Both Hub domains consolidating. Data Foundation: building Databricks platform, EMP foundation, and shared data products. Tech Enabling: establishing CI/CD standards, observability, security baselines, and integration platform evaluation.',
        capabilities: [
          { icon: 'yes', text: 'Data Foundation: Databricks platform consolidating, EMP foundation being built' },
          { icon: 'partial', text: 'Data Foundation: shared decisioning starting to move out of channels' },
          { icon: 'yes', text: 'Tech Enabling: CI/CD pipelines and dev platform standards emerging' },
          { icon: 'partial', text: 'Tech Enabling: observability and security baselines being established' },
          { icon: 'yes', text: 'Both: advisory, engineering support, governance framework established' },
        ],
        tools: ['Databricks', 'EMP (forming)', 'CI/CD', 'Observability (forming)'],
...
const PHASES_DA = [
  {
    ...
    personas: [
      ...
      {
        desc: 'Ingen f\u00e6lles platform eksisterer endnu. Hverken Data Foundation eller Tech Enabling har konsoliderede platforme. Data engineering er fragmenteret, ingen f\u00e6lles decisioning, ingen EMP. Hvert team bygger uafh\u00e6ngigt.',
        capabilities: [
          { icon: 'partial', text: 'Separate cloud-platforme per team \u2014 ingen konsolidering' },
          { icon: 'no', text: 'Ingen f\u00e6lles dataplatform (Data Foundation) eller dev-standarder (Tech Enabling)' },
          { icon: 'no', text: 'Intet f\u00e6lles framework for datakvalitet eller ejerskab' },
          { icon: 'no', text: 'Ingen observability, ingen f\u00e6lles CI/CD, ingen integrationsplatform' },
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Begge Hub-dom\u00e6ner konsoliderer. Data Foundation: bygger Databricks-platform, EMP-fundament og f\u00e6lles dataprodukter. Tech Enabling: etablerer CI/CD-standarder, observability, sikkerhedsbaselines og evaluerer integrationsplatform.',
        capabilities: [
          { icon: 'yes', text: 'Data Foundation: Databricks-platform konsoliderer, EMP-fundament under opbygning' },
          { icon: 'partial', text: 'Data Foundation: f\u00e6lles decisioning begynder at flytte ud af kanaler' },
          { icon: 'yes', text: 'Tech Enabling: CI/CD-pipelines og dev-platformstandarder tager form' },
          { icon: 'partial', text: 'Tech Enabling: observability og sikkerhedsbaselines under etablering' },
          { icon: 'yes', text: 'Begge: r\u00e5dgivning, engineering-support, governance-framework etableret' },
        ],
        tools: ['Databricks', 'EMP (under opbygning)', 'CI/CD', 'Observability (under opbygning)'],
        maturity: { access: 2.5, governance: 2, ai: 2, value: 1.5 },
        tempo: 'both',
      },
      {
