...
const PHASES_EN = [
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Both Hub domains consolidating. Azure \u2192 AWS migration completing \u2014 Data Foundation now runs Databricks on AWS and begins leveraging Tech Enabling\u2019s infrastructure, CI/CD, and observability. EOL foundation being built in Data Foundation; EMP being built by the Audience domain (outside Hub). Tech Enabling: establishing shared dev platform standards and evaluating integration platform.',
        capabilities: [
          ...
          { icon: 'partial', text: 'Data Foundation: shared decisioning starting to move out of channels' },
        ...
        tools: ['Databricks (AWS)', 'EOL (forming)', 'CI/CD', 'Observability (forming)'],
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Owns the engagement layer (channels). Consumes centralised decisioning from the EMP and Experience Orchestration Layer (EOL) \u2014 does not own decisioning itself. Shared business decisions move out of channels into centralized decision services.',
        capabilities: [
          { icon: 'yes', text: 'Shared datasets and a unified Single Customer View (SCV) via standard interfaces' },
          { icon: 'yes', text: 'Consumes decisioning from EMP/EOL as centralised services \u2014 does not build decision logic' },
          { icon: 'yes', text: 'Owns the engagement layer: Play, tv2.dk, Sport, Vejr \u2014 channel-specific delivery & rendering' },
        ...
        tools: ['EOL APIs', 'Adobe Experience Platform', 'Event Streaming', 'Content API'],
        spoke: 'Spoke \u201clille/mellem\u201d \u2014 owns channels (engagement layer)',
        maturity: { access: 3, governance: 2.5, ai: 2.5, value: 3 },
        tempo: 'both',
      },
      {
        desc: 'Spans two Hub domains. Data Foundation: owns the data platform, data products, the Experience Orchestration Layer (EOL), ML models, and shared ontology. Tech Enabling: owns dev platforms, infrastructure, CI/CD, observability, security, and integration platform. EMP is owned outside Hub by the Audience product team.',
        capabilities: [
          { icon: 'yes', text: 'Data Foundation: Databricks platform, data products, Unity Catalog, common data model' },
          { icon: 'yes', text: 'Data Foundation: builds & operates EOL \u2014 orchestration, real-time delivery' },
        ...
        tools: ['Databricks Unity Catalog', 'EOL', 'ML Platform', 'CI/CD', 'Observability'],
        spoke: 'Hub \u2014 Data Foundation (data platform + decision layer) + Tech Enabling (infra + dev platforms)',
      ...
      {
        desc: 'Builds and operates AI factories within product teams. Each team can have its own AI factory with domain-specific agents and local technology choices. Hub provides shared building blocks and patterns, but does not centralise all AI. The Audience product team owns the Experience Management Platform (EMP) \u2014 the business-facing decisioning layer \u2014 outside Hub.',
        capabilities: [
          { icon: 'yes', text: 'Product teams own their AI factories \u2014 agents, models, and domain logic' },
          { icon: 'yes', text: 'Audience domain owns & operates the EMP (decisioning, segments, journeys)' },
          { icon: 'yes', text: 'Hub provides shared AI building blocks, templates, and best practices' },
          { icon: 'yes', text: 'AI model management with cost control and quality monitoring per team' },
          { icon: 'yes', text: 'AI governance tooling: risk assessment, approval workflows, monitoring' },
        ],
        tools: ['Databricks AI', 'Agent Framework', 'EMP (Audience domain)', 'AI Governance Tooling'],
        spoke: 'Product teams \u2014 own AI factories + Audience owns EMP',
...
const PHASES_DA = [
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Begge Hub-dom\u00e6ner konsoliderer. Azure \u2192 AWS-migrering f\u00e6rdigg\u00f8res \u2014 Data Foundation k\u00f8rer nu Databricks p\u00e5 AWS og begynder at bruge Tech Enablings infrastruktur, CI/CD og observability. EOL-fundament under opbygning i Data Foundation; EMP bygges af Audience-dom\u00e6net (uden for Hub). Tech Enabling: etablerer f\u00e6lles dev-platformstandarder og evaluerer integrationsplatform.',
        capabilities: [
          ...
          { icon: 'partial', text: 'Data Foundation: f\u00e6lles decisioning begynder at flytte ud af kanaler' },
        ...
        tools: ['Databricks (AWS)', 'EOL (under opbygning)', 'CI/CD', 'Observability (under opbygning)'],
        maturity: { access: 2.5, governance: 2, ai: 2, value: 1.5 },
        tempo: 'both',
      },
      {
  ...
  },
  {
    ...
    personas: [
      ...
      {
        desc: 'Ejer engagement-laget (kanaler). Forbruger centraliseret decisioning fra EMP og Experience Orchestration Layer (EOL) \u2014 ejer ikke decisioning selv. F\u00e6lles forretningsbeslutninger flyttes ud af kanaler til centraliserede beslutningsservices.',
        capabilities: [
          { icon: 'yes', text: 'F\u00e6lles datas\u00e6t og samlet Single Customer View (SCV) via standard-interfaces' },
          { icon: 'yes', text: 'Forbruger decisioning fra EMP/EOL som centraliserede services \u2014 bygger ikke beslutningslogik' },
          { icon: 'yes', text: 'Ejer engagement-laget: Play, tv2.dk, Sport, Vejr \u2014 kanalspecifik levering & rendering' },
        ...
        tools: ['EOL APIs', 'Adobe Experience Platform', 'Event Streaming', 'Content API'],
        spoke: 'Spoke \u201clille/mellem\u201d \u2014 ejer kanaler (engagement-laget)',
        maturity: { access: 3, governance: 2.5, ai: 2.5, value: 3 },
        tempo: 'both',
      },
      {
        desc: 'D\u00e6kker to Hub-dom\u00e6ner. Data Foundation: ejer dataplatformen, dataprodukter, Experience Orchestration Layer (EOL), ML-modeller og f\u00e6lles ontologi. Tech Enabling: ejer udviklingsplatforme, infrastruktur, CI/CD, observability, sikkerhed og integrationsplatform. EMP ejes uden for Hub af Audience-produktteamet.',
        capabilities: [
          { icon: 'yes', text: 'Data Foundation: Databricks-platform, dataprodukter, Unity Catalog, f\u00e6lles datamodel' },
          { icon: 'yes', text: 'Data Foundation: bygger & driver EOL \u2014 orkestration, realtidslevering' },
        ...
        tools: ['Databricks Unity Catalog', 'EOL', 'ML Platform', 'CI/CD', 'Observability'],
        spoke: 'Hub \u2014 Data Foundation (dataplatform + beslutningslag) + Tech Enabling (infra + udviklingsplatforme)',
        maturity: { access: 3.5, governance: 3, ai: 3.5, value: 2.5 },
        tempo: 'both',
      },
      {
      ...
      {
        desc: 'Bygger og driver AI-fabrikker inden for produktteams. Hvert team kan have sin egen AI-fabrik med dom\u00e6nespecifikke agenter og lokale teknologivalg. Hub leverer f\u00e6lles byggeklodser og m\u00f8nstre, men centraliserer ikke al AI. Audience-produktteamet ejer Experience Management Platform (EMP) \u2014 det forretningsvendte beslutningslag \u2014 uden for Hub.',
        capabilities: [
          { icon: 'yes', text: 'Produktteams ejer deres AI-fabrikker \u2014 agenter, modeller og dom\u00e6nelogik' },
          { icon: 'yes', text: 'Audience-dom\u00e6net ejer & driver EMP (decisioning, segmenter, journeys)' },
          { icon: 'yes', text: 'Hub leverer f\u00e6lles AI-byggeklodser, skabeloner og best practices' },
          { icon: 'yes', text: 'AI-modelstyring med omkostningskontrol og kvalitetsmonitorering per team' },
          { icon: 'yes', text: 'AI governance-v\u00e6rkt\u00f8jer: risikovurdering, godkendelsesworkflows, monitorering' },
        ],
        tools: ['Databricks AI', 'Agent Framework', 'EMP (Audience-dom\u00e6ne)', 'AI Governance Tooling'],
        spoke: 'Produktteams \u2014 ejer AI-fabrikker + Audience ejer EMP',
        maturity: { access: 3.5, governance: 3, ai: 3.5, value: 3 },
        tempo: 'operational',
      },
    ],
...
const GLOSSARY_DA = [
  ...
  { term: 'Experience Orchestration Layer', short: 'EOL \u2014 headless omnichannel-levering', detail: 'En centraliseret runtime-komposition og orkestreringskapacitet til personaliseret, headless omnichannel-indholdslevering. Kombinerer kanal- og kundekontekst med anbefalinger fra EMP. Ejes af Data Foundation (Hub).' },
